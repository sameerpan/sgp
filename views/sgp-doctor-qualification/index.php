 ...
 * @var app\models\SgpDoctorQualificationSearch $searchModel
 */

$this->title = Yii::t('app', 'Doctor Qualifications');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-doctor-qualification-index">
    ...
    'modelClass' => 'Sgp Doctor Qualification',
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-doctor-qualification/view', 'id' => $model->id, 'edit' => 't']),
