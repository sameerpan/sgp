 ...
 * @var app\models\SgpRouteRatesSearch $searchModel
 */

$this->title = Yii::t('app', 'Route Rates');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-route-rates-index">
        ...
        //Sameer - removed Columns that are not required to be displayed
          //  'id',
           // 'designation_id',
            ...
            'rate',
            ['attribute' => 'from_date','format' => ['date',(isset(Yii::$app->modules['datecontrol']['displaySettings']['date'])) ? Yii::$app->modules['datecontrol']['displaySettings']['date'] : 'd-m-Y']],
            ['attribute' => 'to_date','format' => ['date',(isset(Yii::$app->modules['datecontrol']['displaySettings']['date'])) ? Yii::$app->modules['datecontrol']['displaySettings']['date'] : 'd-m-Y']],
//            'is_deleted', 
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-route-rates/view', 'id' => $model->id, 'edit' => 't']),
