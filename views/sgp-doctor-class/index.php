 ...
 * @var app\models\SgpDoctorClassSearch $searchModel
 */

$this->title = Yii::t('app', 'Doctor Classes');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-doctor-class-index">
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-doctor-class/view', 'id' => $model->id, 'edit' => 't']),
