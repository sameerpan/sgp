...
<div class="sgp-designation-form">
    ...
    <?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL]); echo Form::widget([
        ...
        'attributes' => [
            ...
            'designation_name' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => 'Enter Designation Name...', 'maxlength' => 50]],

            'role' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => 'Enter Role Name...']],
