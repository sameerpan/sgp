 ...
 * @var app\models\SgpDesignationSearch $searchModel
 */

$this->title = Yii::t('app', 'Designations');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-designation-index">
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-designation/view', 'id' => $model->id, 'edit' => 't']),
