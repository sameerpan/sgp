 ...
 * @var app\models\SgpExpenseTypeSearch $searchModel
 */

$this->title = Yii::t('app', 'Expense Types');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-expense-type-index">
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-expense-type/view', 'id' => $model->id, 'edit' => 't']),
