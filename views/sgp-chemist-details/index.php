 ...
 * @var app\models\SgpChemistDetailsSearch $searchModel
 */

$this->title = Yii::t('app', 'Chemist Details');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-chemist-details-index">
    ...
    'modelClass' => 'Sgp Chemist Details',
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-chemist-details/view', 'id' => $model->id, 'edit' => 't']),
