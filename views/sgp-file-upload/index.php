 ...
 * @var app\models\SgpFileUploadSearch $searchModel
 */

$this->title = Yii::t('app', 'File Uploads');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-file-upload-index">
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-file-upload/view', 'id' => $model->id, 'edit' => 't']),
