...
<div class="sgp-patch-form">
    ...
    <?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL]); echo Form::widget([
        ...
        'attributes' => [
           ...
           // 'hq_id' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => 'Enter HQ ID...']],

            'patch_name' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => 'Enter Patch Name...', 'maxlength' => 50]],
           ...
           /* 'is_deleted' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => 'Enter Is Deleted...']],
            ...
            'is_delete_approved' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => 'Enter Is Delete Approved...']],
