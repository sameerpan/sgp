 ...
 * @var app\models\SgpStockiestDetailsSearch $searchModel
 */

$this->title = Yii::t('app', 'Stockiest Details');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="sgp-stockiest-details-index">
    ...
    'modelClass' => 'Sgp Stockiest Details',
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['sgp-stockiest-details/view', 'id' => $model->id, 'edit' => 't']),
