...
<div class="sgp-target-view">
    ...
    <?= DetailView::widget([
        ...
        'panel' => [
         ...
         //Sameer - removed attributes that are not required to be display       
        'attributes' => [
//            'id',
            'territory_type',
        //    'territory_id',
        [
            'attribute' => 'territoryType',
            'value' => $model->territoryType->name,
            'type' => DetailView::INPUT_DROPDOWN_LIST, 
            'items'=>$territory_type
        ],
            'target',
            'financial_year',
         /*   'is_deleted',
