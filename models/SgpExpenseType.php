...
/**
 * This is the model class for table "sgp_expense_type".
 *
 * @property integer $id
 ...
 */
class SgpExpenseType extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return SgpExpenseTypeQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new SgpExpenseTypeQuery(get_called_class());
    }
}
