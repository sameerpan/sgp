...
/**
 * This is the model class for table "sgp_stockiest_details".
 *
 * @property integer $id
 ...
 * @property SgpHq $hq
 */
class SgpStockiestDetails extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'contact_id', 'phone', 'address1', 'address2', 'city', 'hq_id', 'gst'], 'required'],
            [['contact_id', 'phone', 'address1', 'address2', 'city', 'hq_id', 'is_deleted', 'crt_by', 'upd_by'], 'integer'],
            [['crt_dt', 'upd_dt'], 'safe'],
